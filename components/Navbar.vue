<template>
    <nav class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Tier 1 projects</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                ...
                <nuxt-link :to="{name: 'border'}"
                    ...
                    <span class="mx-4 font-medium">Border radius previewer</span>
                </nuxt-link>
                ...
                <nuxt-link :to="{name: 'bindec'}"
                    ...
                    <span class="mx-4 font-medium">Bin 2 Dec</span>
                </nuxt-link>
                ...
                <nuxt-link :to="{name: 'freq'}"
                    ...
                    <span class="mx-4 font-medium">Word frequency</span>
                </nuxt-link>
                ...
                <nuxt-link :to="{name: 'truefalse'}"
                    ...
                    <span class="mx-4 font-medium">True or False</span>
                </nuxt-link>
                ...
                <nuxt-link :to="{name: 'github'}"
                    ...
                    <span class="mx-4 font-medium">Github status</span>
                </nuxt-link>
                ...
                <nuxt-link :to="{name: 'calc'}"
                    ...
                    <span class="mx-4 font-medium">Calculator</span>
                </nuxt-link>
